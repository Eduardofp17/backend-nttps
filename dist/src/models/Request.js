...
var RequestsModel = /** @class */ (function (_super) {
    __extends(RequestsModel, _super);
    function RequestsModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RequestsModel.init = function (sequelize) {
        var _this = this;
        ...
        }, { sequelize: sequelize, tableName: 'Requests' });
    ...
    RequestsModel.prototype.passwordValid = function (password) {
        return bcryptjs_1.default.compare(password, this.password_hash);
    };
    RequestsModel.associate = function (models) {
