...
var SchoolModel = /** @class */ (function (_super) {
    __extends(SchoolModel, _super);
    function SchoolModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SchoolModel.init = function (sequelize) {
        var _this = this;
        ...
        }, { sequelize: sequelize, tableName: 'Schools' });
    ...
    SchoolModel.prototype.passwordValid = function (password) {
        return bcryptjs_1.default.compare(password, this.password_hash);
    };
    SchoolModel.associate = function (models) {
